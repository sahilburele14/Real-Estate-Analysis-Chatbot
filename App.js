          ...
          <div className="h-[600px] overflow-y-auto p-6 space-y-4 bg-gray-50">
            {messages.map((msg, idx) => (
              <div key={idx} className={`flex ${msg.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[80%] ${msg.type === 'user' ? 'bg-blue-600 text-white' : 'bg-white border border-gray-200'} rounded-2xl p-4 shadow-md`}>
                      ...
                      <ResponsiveContainer width="100%" height={250}>
                        <LineChart data={msg.chartData}>
                          ...
                          {msg.queryType === 'comparison' ? (
                            ...
                            <>
                              <Line yAxisId="left" type="monotone" dataKey="price" stroke="#3b82f6" strokeWidth={2} name="Avg Price (₹/sqft)" />
                              <Line yAxisId="right" type="monotone" dataKey="demand" stroke="#10b981" strokeWidth={2} name="Demand Index" />
                            </>
                          )}
                        </LineChart>
                      </ResponsiveContainer>
